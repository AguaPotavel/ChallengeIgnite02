...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    let jsonValue = await AsyncStorage.getItem('@passmanager:logins')
    let loginsStored = jsonValue != null ? JSON.parse(jsonValue) : [];
    jsonValue = JSON.stringify([...loginsStored, newLoginData])
    await AsyncStorage.setItem('@passmanager:logins', jsonValue)
    jsonValue = await AsyncStorage.getItem('@passmanager:logins')
